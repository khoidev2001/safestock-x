...
export const styles = StyleSheet.create({
  ...
  // Chuyển cục bộ giữa soạn báo cáo và lịch sử; mỗi tab đạt vùng chạm tối thiểu 44px.
  reportTabs: {
    flexDirection: "row",
    gap: 8,
    paddingHorizontal: 16,
  ...
  reportTabSelected: { backgroundColor: c.amber, borderColor: c.amber },
  reportTabText: { color: c.muted, fontSize: 14, fontWeight: "700" },
  reportTabTextSelected: { color: c.bg },
  smallControl: { minWidth: 44, minHeight: 44, alignItems: "center", justifyContent: "center" },
  touchControl: { minWidth: 44, minHeight: 44, alignItems: "center", justifyContent: "center" },
  retryControl: { minHeight: 44, minWidth: 88, alignItems: "center", justifyContent: "center" },
  secondaryButton: {
    minHeight: 44,
    borderWidth: 1,
    borderColor: c.green,
  ...
  secondaryButtonText: { color: "#4ade80", fontSize: 14, fontWeight: "800" },
  audioPendingText: {
    color: "#fbbf24",
    fontSize: 13,
    lineHeight: 19,
  ...
  // Lịch sử báo cáo riêng của REPORTER.
  reportList: { flex: 1 },
  reportListPadding: { padding: 16, paddingBottom: 32 },
  reportListEmpty: { flexGrow: 1 },
  reportCard: {
    backgroundColor: c.surface,
    borderWidth: 1,
    borderColor: c.border,
  ...
  reportCardIcon: { fontSize: 26 },
  reportCardTitle: { color: c.text, fontSize: 17, fontWeight: "800" },
  reportCardDate: { color: c.muted, fontSize: 12, marginTop: 2 },
  reportCardArrow: { color: c.amber, fontSize: 28, fontWeight: "400" },
  reportCardDescription: { color: c.text, fontSize: 14, lineHeight: 20, marginTop: 12 },
  reportCardStatusRow: {
    flexDirection: "row",
    alignItems: "center",
    justifyContent: "space-between",
  ...
  reportStatusText: { color: c.text, fontSize: 12, fontWeight: "700" },
  reportProcessingText: { color: c.amber, fontSize: 12, fontWeight: "700" },
  listFooterText: { color: c.muted, textAlign: "center", paddingVertical: 14 },
  cachedErrorBox: {
  ...
  cachedErrorText: { color: "#fca5a5", fontSize: 13, lineHeight: 19 },

  // Chi tiết báo cáo của REPORTER.
  detailHeaderRow: {
    minHeight: 56,
    flexDirection: "row",
    alignItems: "center",
  ...
  detailHeaderTitle: { color: c.text, fontSize: 17, fontWeight: "800" },
  detailDescriptionLabel: { color: c.muted, fontSize: 12, fontWeight: "700", marginBottom: 6 },
  detailDescription: {
    color: c.text,
    fontSize: 16,
    lineHeight: 23,
  ...
  detailStatusGrid: { gap: 10, marginBottom: 10 },
  detailStatusFact: {
    backgroundColor: c.surface,
    borderWidth: 1,
    borderColor: c.border,
  ...
  detailFieldLabel: { color: c.muted, fontSize: 12, fontWeight: "700", marginBottom: 4 },
  detailFieldValue: { color: c.text, fontSize: 14, lineHeight: 20 },
});
