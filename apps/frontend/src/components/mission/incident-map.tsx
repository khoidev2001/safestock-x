...
const TILE_ATTRIBUTION =
  '&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> · bản đồ offline';
...
export function IncidentMap({ warehouses, incidentPoint }: IncidentMapProps) {
    ...
    <div className="space-y-2">
      <div className="h-[320px] overflow-hidden rounded-md border">
        ...
        >
          ...
          {incidentPoint ? (
            <Marker position={[incidentPoint.lat, incidentPoint.lng]} icon={incidentIcon}>
