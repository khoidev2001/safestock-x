...
export const MISSION_NORMS: Record<IncidentType, NormRule[]> = {
  [IncidentType.FLOOD]: [
    { sku: "LIFE-ADULT", itemName: "Áo phao người lớn", unit: "chiếc", perUnit: 1, basis: "PER_PERSON" },
    { sku: "LIFE-CHILD", itemName: "Áo phao trẻ em", unit: "chiếc", perUnit: 1, basis: "PER_CHILD" },
    { sku: "WATER-01", itemName: "Nước uống đóng chai", unit: "lít", perUnit: 15, basis: "PER_PERSON_PER_DAY" },
    { sku: "FIRSTAID-01", itemName: "Bộ sơ cứu", unit: "bộ", perUnit: 1, basis: "PER_MEDICAL_CASE" },
  ...
  [IncidentType.FIRE]: [
    { sku: "FIRSTAID-01", itemName: "Bộ sơ cứu", unit: "bộ", perUnit: 1, basis: "PER_MEDICAL_CASE" },
    { sku: "WATER-01", itemName: "Nước uống đóng chai", unit: "lít", perUnit: 5, basis: "PER_PERSON_PER_DAY" },
  ],
